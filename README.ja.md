...
プロジェクトのライブプレビューやデバッグなどの機能を実装しています。
構文強調は含まれておらず、[公式のレポジトリ](https://github.com/aspizu/goboscript/tree/main/editors/code)より別途インストールが必要です。

## 機能

- ライブステージ: プロジェクトをリアルタイムでビルドしエディタ内で実行できます
- プロパティウォッチャ: スプライトやクローンのプロパティ（x,y座標、方向、コスチュームなど）
...
**[Releases](/Funaen/goboscript-vscode-ide/releases)**ページからVSIXファイルをダウンロードしてください。
