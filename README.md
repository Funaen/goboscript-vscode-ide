...
A powerful development environment for goboscript, designed to streamline your workflow with real-time monitoring and debugging features.**This extenison doesn't support syntaxhilight.Please use [the official extension](https://github.com/aspizu/goboscript/tree/main/editors/code).**
